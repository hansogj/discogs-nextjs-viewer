...
This is a web application built with Next.js that allows you to view your Discogs record collection and wantlist. It uses the Discogs API for data and a Redis cache for a fast and seamless experience across sessions.
...
- **Redis-backed Caching**: Fetched data from Discogs is cached in Redis (AOF + RDB persistence) to prevent hitting API rate limits and for near-instant loads across server restarts.
