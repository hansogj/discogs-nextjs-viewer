    ...
    <div className="flex flex-col gap-4">
      {users.length > 0 && (
        <div className="flex flex-col gap-2">
          <p className="text-sm text-discogs-text-secondary">{t("signInAs")}</p>
          ...
          <div className="relative my-1 flex items-center">
            ...
            <span className="mx-3 text-xs text-discogs-text-secondary">
              {t("orDivider")}
            </span>
            <div className="flex-grow border-t border-discogs-border"></div>
          </div>
      ...
      >
        {users.length > 0 ? t("loginWithAnother") : t("loginWithDiscogs")}
      </button>
    </div>
  );
};
